...
app.use('/answers', require('./routers/answers.router'))
app.use('/survies', require('./routers/survey.router'))
app.use('/surveytest', require('./routers/surveytest.router'))
app.use('/statistics', require('./routers/statistics.router'))
